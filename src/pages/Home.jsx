        ...
        <motion.section className="home" {...slideAnimation('left')}>
          ...
          <motion.div {...headContainerAnimation} className="home-content">
            ...
            <motion.div {...headContentAnimation} className="flex flex-col gap-5" >
              <p className="mx-w-md font-normal text-gray-600">Create your unique and exclusive shirt with our brand-new 3d customization tool. <strong>Unleash your imagination</strong> and define your own style.</p>
